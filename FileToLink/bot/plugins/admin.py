...
from FileToLink.utils.broadcast_helper import send_msg
...
@FileToLink.on_message(filters.command("status") & filters.private & filters.user(Telegram.OWNER_ID))
...
@FileToLink.on_message(filters.command("ban") & filters.private & filters.user(Telegram.OWNER_ID))
...
@FileToLink.on_message(filters.command("unban") & filters.private & filters.user(Telegram.OWNER_ID))
async def sts(b, m: Message):
...
@FileToLink.on_message(filters.command("broadcast") & filters.private & filters.user(Telegram.OWNER_ID) & filters.reply)
...
@FileToLink.on_message(filters.command("del") & filters.private & filters.user(Telegram.OWNER_ID))
async def sts(c: Client, m: Message):
