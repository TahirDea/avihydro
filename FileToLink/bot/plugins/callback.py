...
from FileToLink.utils.bot_utils import gen_link
from FileToLink.utils.database import Database
from FileToLink.utils.human_readable import humanbytes
...
#---------------------[ START CMD ]---------------------#
@FileToLink.on_callback_query()
async def cb_data(bot, update: CallbackQuery):
    usr_cmd = update.data.split("_")
    if usr_cmd[0] == "home":
        await update.message.edit_text(
            text=LANG.START_TEXT.format(update.from_user.mention, FileToLink.username),
