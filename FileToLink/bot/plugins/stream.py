...
import asyncio
from FileToLink.bot import FileToLink, multi_clients
from FileToLink.utils.bot_utils import is_user_banned, is_user_exist, is_user_joined, gen_link, is_channel_banned, is_channel_exist, is_user_authorized
from FileToLink.utils.database import Database
from FileToLink.utils.file_properties import get_file_ids, get_file_info
        ...
        await bot.edit_message_reply_markup(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("Dᴏᴡɴʟᴏᴀᴅ ʟɪɴᴋ 📥",
                                       url=f"https://t.me/{FileToLink.username}?start=stream_{str(inserted_id)}")]])
        )
